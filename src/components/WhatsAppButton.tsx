      ...
      >
        <div className="bg-white rounded-2xl shadow-2xl p-5 w-72 border border-gray-100">
          <div className="flex items-center gap-3 mb-3">
            ...
            <div>
              <p className="font-bold text-sm text-dark">Santana & Dantas</p>
              <p className="text-xs text-green-600">Online agora</p>
            </div>
            <button
              onClick={() => setExpanded(false)}
              className="ml-auto text-gray hover:text-dark transition-colors"
            >
          ...
          <div className="bg-light rounded-lg p-3 mb-3">
            <p className="text-sm text-dark">
              Olá! 👋 Como podemos ajudá-lo? Clique abaixo para falar com um de nossos advogados.
            </p>
          </div>
          <a
        ...
        {/* Arrow */}
        <div className="w-4 h-4 bg-white rotate-45 transform absolute -bottom-2 right-8 border-r border-b border-gray-100" />
      </div>

      {/* Button */}
      <button
        onClick={() => setExpanded(!expanded)}
        className="group relative w-16 h-16 bg-green-500 hover:bg-green-600 rounded-full shadow-lg hover:shadow-2xl flex items-center justify-center transition-all duration-300 hover:scale-110"
      >
        {/* Pulse ring */}
