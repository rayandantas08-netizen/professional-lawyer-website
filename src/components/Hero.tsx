    ...
    >
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center pt-20">
        ...
        <div className="animate-fadeInUp delay-300 flex flex-col sm:flex-row items-center justify-center gap-4">
          {/* Botão Fale Conosco com dropdown */}
          <div className="relative inline-block">
            ...
            >
              ...
              Fale Conosco
              <svg className={`w-4 h-4 transition-transform duration-300 ${openContatos ? 'rotate-180' : ''}`} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
            ...
            {/* Menu de contatos */}
            {openContatos && (
              <div className="absolute top-full left-0 mt-2 bg-white rounded-xl shadow-2xl border border-gray-100 min-w-[280px] z-50 animate-fadeInUp overflow-hidden">
                <div className="p-3">
                  <p className="text-xs text-gray-500 uppercase tracking-wider mb-2 text-center">Escolha um advogado</p>
                  <a
                  ...
                  >
                    ...
                    <div className="text-left">
                      <p className="font-medium text-dark text-sm">Dra. Fernanda Dantas</p>
                      <p className="text-xs text-gray-500">(99) 98488-1281</p>
                    </div>
                    <svg className="w-4 h-4 text-gray-400 ml-auto group-hover:text-green-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                      <path strokeLinecap="round" strokeLinejoin="round" d="M9 5l7 7-7 7" />
                    </svg>
                  </a>
                  <a
                    href="https://wa.me/5599984042123?text=Olá! Gostaria de agendar uma consulta."
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center gap-3 p-3 rounded-lg hover:bg-green-50 transition-colors group"
                    onClick={() => setOpenContatos(false)}
                  >
                    ...
                    <div className="text-left">
                      <p className="font-medium text-dark text-sm">Dr. Thiago Santana</p>
                      <p className="text-xs text-gray-500">(99) 98404-2123</p>
                    </div>
                    <svg className="w-4 h-4 text-gray-400 ml-auto group-hover:text-green-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                      <path strokeLinecap="round" strokeLinejoin="round" d="M9 5l7 7-7 7" />
                    </svg>
